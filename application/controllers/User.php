    ...
    public function index()
    {
        if (isset($_SESSION['username'])){
            ...
            if ($_SESSION['username'] == $cek['username']){
                ...
                if ($this->form_validation->run() == false || password_verify($old_pass,$db_pass) == false){//password verify
                    if (isset($old_pass) && !password_verify($old_pass,$_SESSION['password'])){$this->session->set_flashdata('message_pass','<div class="alert alert-danger" role="alert">Password lama anda salah!</div>');}
                    ...
                    if ($_FILES['foto']['name'] !== ''){//check uploaded file
