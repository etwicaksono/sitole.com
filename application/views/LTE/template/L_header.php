...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?= base_url('vendor/LTE/') ?>bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= base_url('vendor/LTE/') ?>bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?= base_url('vendor/LTE/') ?>bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url('vendor/LTE/') ?>dist/css/AdminLTE.min.css">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('vendor/LTE/') ?>index2.html" class="logo">
                ...
                <span class="logo-lg"><img src="<?= base_url('assets/img/favicon.png') ?>" alt=""
                        style="width:50px;"><b>Sitole.com</b></span>
            </a>
