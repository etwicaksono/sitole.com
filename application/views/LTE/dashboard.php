                    ...
                    <div id="contoh-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="<?= base_url('assets/img/slide/slide 1.jpg') ?>" alt="Gambar Pertama"
                            ...
                            <div class="item">
                                <img src="<?= base_url('assets/img/slide/slide 2.jpg') ?>" alt="Gambar Kedua"
                                    style="width: 100%;height:300px;">
                                <div class="carousel-caption">
                                    <h3>SLIDE 2</h3>
                                </div>
                            ...
                            <div class="item">
                                <img src="<?= base_url('assets/img/slide/slide 3.png') ?>" alt="Gambar Ketiga"
                                    style="width: 100%;height:300px;">
                                <div class="carousel-caption">
                                    <h3>SLIDE 3</h3>
                                </div>
